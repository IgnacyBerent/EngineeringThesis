...
As a primary regulator of the autonomic nervous system, the baroreflex maintains homeostasis via a negative feedback loop that stabilizes heart period (HP) despite shifts in systolic arterial pressure (SAP). 
Baroreflex sensitivity (BRS) quantifies how HP fluctuates in response to SAP changes. 
Notably, the chemoreflex effect, driven by ETCO$_2$ levels, often acts as a confounding factor in controlled breathing protocols, introducing bias in BRS estimation.

Physiological signals were collected from 32 healthy volunteers (14 males, 18 females, median age: 22 years) during the \textit{AUTOMATIC} project at Wrocław University of Science and Technology. 
...
Arterial blood pressure and ETCO$_2$ were recorded noninvasively. 
SAP and HP were then derived from the pressure signal, and ETCO$_2$ was upsampled to match their length.
...
Future research with larger cohorts and longer recordings will offer more generalized insights.
