...
Similarly to the definition \ref{eq:te}  
$CTE_{Y\to X|Z}$ is equal to:
...
Conditional Joint Transfer Entropy (CJTE) allows to calculate transfer from two sources $X$ and $Y$ to $Z$, under condition $W$, yet often $Y=W$ is used.
