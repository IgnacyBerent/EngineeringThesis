...
All of the following TE algorithms were implemented from scratch in \textit{python} programing language, with detailed description in section \ref{sec:te-implementation}.
...
For this paper I have decided to implement from scratch the Darbelly-Vajda Partitioning (DVP) algorithm for its reliability, and parameter free approach (implementation in section \ref{sec:dvp-implementation})  (\cite{lee2012transfer};\cite{rozo2021benchmarking};\cite{dvp}).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{figs/dvp.png}
