...
This suggests a synergistic effect where knowledge of the past of $Z$ renders the "echo" of the drive found in $X$ more predictive of $Y$. 
While this is a documented property of information-theoretic measures in the presence of a common cause, it implies that in high-dimensional physiological spaces, the estimator may overestimate the conditional flow if the shared drive is dominant. 
