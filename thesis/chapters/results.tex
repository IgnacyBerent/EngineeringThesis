...
\subsection{Effect of Linear Coupling Strength} 
...
\subsection{Effect of Signal Length}
...
\subsection{Effect of Nonlinear Coupling Strength}
...
\subsection{Effect of a Confounding Variable}
...
\subsubsection{Effect on $TE_{Z \to X}$ and $TE_{Z \to Y}$}
...
\subsubsection{Comparison of $TE_{X->Y}$ with $CJTE_{(X,Z)->Y|Z}$}
...
\subsection{BRS Estimation Using TE}
...
\subsection{Information Flow From ETCO$_2$}
...
\subsection{BRS Estimation Using CJTE}
...
\subsection{Comparison of TE and CJTE in BRS estimation}
