...
Based on concepts of Information Theory by Shannon, new techniques of accessing relationship in complex systems have been introduced with big potential in analysis of the physiological data, such as covered in this work Transfer Entropy (TE) (\cite{Shannon1948}; \cite{Schreiber2000};\cite{genccaga2018transfer};\cite{wen2023kendall}).
