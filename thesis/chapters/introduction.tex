...
% Czego nam brakuje?
Our human body is an extremly complex biological machinery build from numerous mutually dependent mechanisms. 
...
Based on concepts of Information Theory by Shannon, new techniques of accessing relationship in complex systems have been introduced, such as analysed in this work Transfer Entropy (TE) (\cite{Shannon1948};\cite{Schreiber2000};\cite{genccaga2018transfer}).
