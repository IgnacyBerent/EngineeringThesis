...
This chapter introduces the fundamental concepts and the motivation behind this thesis. 
It begins by discussing the complexity of human physiological regulation and the limitations of traditional analytical methods, emphasizing importance of developing more advanced solutions.
Subsequently, the specific aims and the scope of the research are defined.
...
Based on concepts of Information Theory by Shannon, new techniques of accessing casual relationships in complex systems have been introduced with big potential in analysis of the physiological data, such as covered in this work transfer entropy (TE) and conditional joint transfer entropy (CJTE) (\cite{Shannon1948}; \cite{Schreiber2000};
\cite{genccaga2018transfer};\cite{wen2023kendall};\cite{wibral2011transfer}).

\section{Aim}
The aim of this work is to conduct a comparative analysis of algorithms for TE and CJTE, with consideration of a modulating variable. 
The analysis will assess the impact of analytical parameters used in entropy estimation on the results of TE and CJTE in both simulated and physiological signals.

\section{Scope}
The scope of this thesis encompasses the following tasks:
\begin{enumerate}
    ...
    \item Implementation of selected algorithms for TE and CJTE
...
\section{Source Code}
All the code implementations are open source, and are present at the GitHub repository under the following url: \\
\url{https://github.com/IgnacyBerent/EngineeringThesis}
